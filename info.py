...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001949670967 -1002152290193').split()]  # For Multiple Id Use One Space Between Each.
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'bollywala') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.
